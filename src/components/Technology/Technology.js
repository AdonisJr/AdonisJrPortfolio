...
export default function Technology({technologies}) {
  ...
  const listOfTechnology = [...technologies].map(
    (technology, index) =>{
      
        return(
          <div className={index % 2 == 0 ? 'list col-sm-6 rounded-left': 'list2 col-sm-6 rounded-right'}
          data-aos={index % 2 == 0 ? 'fade-right': 'fade-left'}
          key={technology.tech}>
              
              <div className="image py-2">
                {
                  technology.tech.toLowerCase() == 'html' ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-filetype-html" viewBox="0 0 16 16">
                      <path fill-rule="evenodd" d="M14 4.5V11h-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5L14 4.5Zm-9.736 7.35v3.999h-.791v-1.714H1.79v1.714H1V11.85h.791v1.626h1.682V11.85h.79Zm2.251.662v3.337h-.794v-3.337H4.588v-.662h3.064v.662H6.515Zm2.176 3.337v-2.66h.038l.952 2.159h.516l.946-2.16h.038v2.661h.715V11.85h-.8l-1.14 2.596H9.93L8.79 11.85h-.805v3.999h.706Zm4.71-.674h1.696v.674H12.61V11.85h.79v3.325Z"/>
                    </svg> :
                  technology.tech.toLowerCase() == 'css' ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-filetype-css" viewBox="0 0 16 16">
                  ...
                  technology.tech.toLowerCase() == 'sass' ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-filetype-sass" viewBox="0 0 16 16">
                  ...
                  technology.tech.toLowerCase() == 'javascript' ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-filetype-js" viewBox="0 0 16 16">
                  ...
                  technology.tech.toLowerCase() == 'bootstrap' ?
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-bootstrap" viewBox="0 0 16 16">
                      <path d="M5.062 12h3.475c1.804 0 2.888-.908 2.888-2.396 0-1.102-.761-1.916-1.904-2.034v-.1c.832-.14 1.482-.93 1.482-1.816 0-1.3-.955-2.11-2.542-2.11H5.062V12zm1.313-4.875V4.658h1.78c.973 0 1.542.457 1.542 1.237 0 .802-.604 1.23-1.764 1.23H6.375zm0 3.762V8.162h1.822c1.236 0 1.887.463 1.887 1.348 0 .896-.627 1.377-1.811 1.377H6.375z"/>
                      <path d="M0 4a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4zm4-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V4a3 3 0 0 0-3-3H4z"/>
                    </svg> :
                  technology.tech.toLowerCase() == 'react js' ?
                    <img src={reactImg} alt="" /> :
                  technology.tech.toLowerCase() == 'node js' ?
                    <img src={nodeImg} alt="" /> :
                  technology.tech.toLowerCase() == 'express js' ?
                    <img src={expressImg} alt="" /> :
                  technology.tech.toLowerCase() == 'mysql' ?
                    <img src={mysqlImg} alt="" />
                  : <img src={mongoImg} alt="" />
                }
                {console.log(technology.tech.toLowerCase())}
